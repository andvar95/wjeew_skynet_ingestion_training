...
Feature: Tests for t_kdit_certonlinetwo in kdit
  ...
  @execute
  Scenario: t_kdit_certonlinetwo-raw-punctual
    Given an ingestion config file ${repository.endpoint}/${repository.repo}/kirby/mx/kdit/raw/t_kdit_certonlinetwo/${version}/t_kdit_certonlinetwo.conf
