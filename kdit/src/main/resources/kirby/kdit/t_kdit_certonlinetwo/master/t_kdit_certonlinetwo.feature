@kdit
Feature: Tests for t_kdit_certonlinetwo in kdit

  @execute
  Scenario: t_kdit_certonlinetwo-master-punctual
    Given an ingestion config file ${repository.endpoint}/${repository.repo}/kirby/mx/kdit/master/t_kdit_certonlinetwo/${version}/t_kdit_certonlinetwo.conf
