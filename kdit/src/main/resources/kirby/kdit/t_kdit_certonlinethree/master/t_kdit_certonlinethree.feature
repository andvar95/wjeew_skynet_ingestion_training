...
Feature: Tests for t_kdit_certonlinethree in kdit
  ...
  @execute
  Scenario: t_kdit_certonlinethree-master-punctual
    Given an ingestion config file ${repository.endpoint}/${repository.repo}/kirby/mx/kdit/master/t_kdit_certonlinethree/${version}/t_kdit_certonlinethree.conf
