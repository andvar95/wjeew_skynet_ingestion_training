@kdit
Feature: Tests for t_kdit_training in kdit

  @execute
  Scenario: t_kdit_training-master-punctual
    Given an ingestion config file ${repository.endpoint}/${repository.repo}/kirby/mx/kdit/master/t_kdit_training/${version}/t_kdit_training.conf
