...
Feature: Tests for t_kdit_certonlineone in kdit
  ...
  @execute
  Scenario: t_kdit_certonlineone-raw-punctual
    Given an ingestion config file ${repository.endpoint}/${repository.repo}/kirby/mx/kdit/raw/t_kdit_certonlineone/${version}/t_kdit_certonlineone.conf
