@kdit
Feature: Tests for t_kdit_certonlineone in kdit

  @execute
  Scenario: t_kdit_certonlineone-master-punctual
    Given an ingestion config file ${repository.endpoint}/${repository.repo}/kirby/mx/kdit/master/t_kdit_certonlineone/${version}/t_kdit_certonlineone.conf
